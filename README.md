...
## Latest reliability changes

- Weather dashboard forecast: MET Norway Locationforecast 2.0, 7-day outlook, 10-minute cache, update-age display.
- Police alerts: phone-side 30-minute polling is disabled. The intended production path is the optional server-side Politiloggen Atom monitor -> FCM -> Android.
- Bitcoin and currency cards show the age of the fetched market data.
