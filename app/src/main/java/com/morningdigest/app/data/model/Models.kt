...
data class WeatherTomorrow(
    ...
    val parts: List<DayPartForecast> = emptyList(),
    /** When MET Norway last updated the forecast used by this card. */
...
data class WeatherDayForecast(
    ...
    val humidity: Int? = null,
    val windSpeed: Double? = null,
    /** When the MET Norway forecast used for this day was published/updated. */
    val forecastUpdatedAtMillis: Long? = null
)
...
data class BitcoinInfo(
    ...
    /** Time this market quote was fetched from the provider. */
